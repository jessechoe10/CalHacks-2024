...
function App() {
  ...
  const AttentionPage = () => (
    ...
    >
        <Header />
        <div className="flex justify-between items-center flex-grow p-6"> {/* Added padding */}
            <div className="flex justify-center items-center w-1/2 pr-4"> {/* Added right padding */}
                <video
                    ref={videoRef}
            ...
            <div className="w-1/2 flex flex-col items-start justify-center"> {/* Center vertically */}
                <AnimatePresence>
                    {showQuestion && ( // Ensure showQuestion is true
                        ...
                        >
                            <p className="text-base mt-2 text-white"> {/* Set text color to white */}
